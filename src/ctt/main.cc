...
namespace simple_sat_solver::ctt {
  void Test(std::string test_file_path, std::string test_file, std::string log_dir, ::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory * encoder, std::string encoder_message, int start_penalty) {
...
//      outfile.close();
  ...
  void Test(std::string file, int start_penalty) {
    ::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory * encoder_factory = new ::Pumpkin::IncrementalSequentialEncoder::Factory();
//    ::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory * encoder_factory = new ::Pumpkin::TotaliserEncoder::Factory();
//    ::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory * encoder_factory = new ::Pumpkin::PropagatorEncoder::Factory();
...
void test_file(std::string file, int start_penalty) {
  ...
  test_setting(dir + file, file, log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", true, false, start_penalty, 1);
  test_setting(dir + file, file, log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", true, true, start_penalty, 1);
  test_setting(dir + file, file, log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::PropagatorEncoder<Pumpkin::CardinalityConstraint>::Factory(), "Propagator", false, false, start_penalty, 1);
  test_setting(dir + file, file, log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", false, false, start_penalty, 1);
}
...
int main(int argc, char *argv[]) {
  if (argc >= 4) {
     ...
     ::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory * factory;
     switch (s) {
     case encoder:
       test_setting(test_file, "test", log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", false, false, start_penalty, add_delay);
       break;
     case dynamic:
       test_setting(test_file, "test", log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", true, false, start_penalty, add_delay);
       break;
     case incremental:
       test_setting(test_file, "test", log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::IncrementalSequentialEncoder::Factory(), "Incremental", true, true, start_penalty, add_delay);
       break;
     case propagator:
       test_setting(test_file, "test", log_dir, (::Pumpkin::IEncoder<::Pumpkin::CardinalityConstraint>::IFactory *) new ::Pumpkin::PropagatorEncoder<Pumpkin::CardinalityConstraint>::Factory(), "Propagator", false, false, start_penalty, add_delay);
       break;
     default:
       return 1;
     }
