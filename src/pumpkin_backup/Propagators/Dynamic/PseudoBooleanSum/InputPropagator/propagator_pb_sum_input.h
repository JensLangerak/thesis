...
#ifndef SIMPLESATSOLVER_SRC_PUMPKIN_PROPAGATORS_DYNAMIC_PSEUDOBOOLEANSUM_INPUTPROPAGATOR_PROPAGATOR_PB_SUM_INPUT_H_
#define SIMPLESATSOLVER_SRC_PUMPKIN_PROPAGATORS_DYNAMIC_PSEUDOBOOLEANSUM_INPUTPROPAGATOR_PROPAGATOR_PB_SUM_INPUT_H_
...
public:
  ...
  ~PropagatorPbSumInput() override = default;
