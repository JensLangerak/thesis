...
#ifndef SIMPLESATSOLVER_SRC_PUMPKIN_PROPAGATORS_DYNAMIC_PSEUDOBOOLEANSUM_OUPUTPROPAGATOR_REASON_PB_SUM_CONSTRAINT_OUTPUT_H_
#define SIMPLESATSOLVER_SRC_PUMPKIN_PROPAGATORS_DYNAMIC_PSEUDOBOOLEANSUM_OUPUTPROPAGATOR_REASON_PB_SUM_CONSTRAINT_OUTPUT_H_

#include "../../../../Engine/solver_state.h"
#include "../watched_pb_sum_constraint.h"
#include "explanation_pb_sum_constraint_output.h"
namespace Pumpkin {
class ReasonPbSumConstraintOutput : public ReasonGeneric {
public:
  ReasonPbSumConstraintOutput(WatchedPbSumConstraint *constraint,
  SolverState &state);
...
private:
  ExplanationPbSumConstraintOutput *explanation_;
