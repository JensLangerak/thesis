...
bool PropagatorDynamic<T,P>::AddEncoding(SolverState &state,
                                    T *constraint) {
  int clause_index =
...
template <class T, class P>
bool PropagatorDynamic<T,P>::ClausualPropagateLiteral(
...
template <class T, class P>
int PropagatorDynamic<T,P>::PropagateLiterals(
    std::priority_queue<PropagtionElement, std::vector<PropagtionElement>,
...
PropagatorDynamic<T,P>::AddEncodingClauses(SolverState &state,
                                      T *constraint) {
  std::vector<std::vector<BooleanLiteral>> clauses;
  IEncoder<P> * encoder = GetEncoder(constraint);
...
template <class T, class P>
std::priority_queue<typename PropagatorDynamic<T,P>::PropagtionElement,
                    std::vector<typename PropagatorDynamic<T,P>::PropagtionElement>,
                    std::greater<typename PropagatorDynamic<T,P>::PropagtionElement>>
PropagatorDynamic<T,P>::InitPropagationQueue(SolverState &state,
...
template <class T, class P>
void PropagatorDynamic<T,P>::UpdatePropagation(
    SolverState &state,
    std::priority_queue<PropagtionElement, std::vector<PropagtionElement>,
                        std::greater<PropagtionElement>>&
        propagation_queue,
...
template <class T, class P>
void PropagatorDynamic<T,P>::RepairTrailPositions(SolverState &state) {
...
template <class T, class P>
bool PropagatorDynamic<T,P>::PropagateIncremental(
...
template <class T, class P>
void PropagatorDynamic<T,P>::PropagateAddedClauses(SolverState &state,
                                                 int unit_start_index,
                                                 int clause_start_index,
                                                 int var_start_index) {
...
template class PropagatorDynamic<WatchedPseudoBooleanConstraint3, PseudoBooleanConstraint>;
