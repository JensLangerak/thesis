...
class PropagatorCardinality : public PropagatorDynamic<WatchedCardinalityConstraint, CardinalityConstraint> {
public:
...
//private:
  ...
  IEncoder<CardinalityConstraint> * GetEncoder(WatchedCardinalityConstraint * constraint) override { return constraint->encoder_;};
