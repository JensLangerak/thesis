...
public:
	...
	typename std::vector<BooleanVariable>::const_iterator begin() const; //iterators over the objective literals
...
private:
	...
	VectorObjectIndexed<BooleanVariable, int64_t> weights_;
