...
typedef std::vector<BooleanLiteral> Disjunction; //mainly to increase readability, i.e. to emphasize what the vector represents //not sure if I need disjunction
typedef std::vector<BooleanLiteral> Conjunction; //mainly to increase readability, i.e. to emphasize what the vector represents
