...
void DirectlyHashedBooleanVariableLabeller::AssignLabel(BooleanVariable variable, char label)
{
...
{
	for (BooleanVariable variable : labelled_variables_) { variable_labels_[variable] = UNLABELLED; }
	labelled_variables_.clear();
}

bool DirectlyHashedBooleanVariableLabeller::IsLabelled(BooleanVariable variable) const
{
	return variable_labels_[variable] != UNLABELLED;
}

bool DirectlyHashedBooleanVariableLabeller::IsAssignedSpecificLabel(BooleanVariable variable, char label)
{
	assert(label != UNLABELLED);
	return variable_labels_[variable] == label;
}

char DirectlyHashedBooleanVariableLabeller::GetLabel(BooleanVariable variable) const
{
